...
@php
    ...
    $options = [
        ...
        'rangeSeparator' => $resolvedLabels['rangeSeparator'],
        'incompleteRange' => $resolvedLabels['incompleteRange'],
    ];
...
<div
    x-data="{{ 'lyraDateRangePicker('.$optionsLiteral.')' }}"
    x-modelable="selected"
    @if ($name !== null)
        @lyra:change="$refs.nativeStart.value = $event.detail.value?.start ?? ''; $refs.nativeEnd.value = $event.detail.value?.end ?? ''"
    @endif
    {{ $modelAttributes }}
    {{ $rootAttributes }}
>
