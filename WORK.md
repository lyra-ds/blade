...
## In progress
- [ ] Onda 1 (irmãos do Button, sequencial): Spinner ✅ → Badge → Tag → Separator → Skeleton → Progress — lane medium (codex default) via Compozy, um ciclo/commit por item; scout único (bonsai) extraindo contrato dos 6 (disparada 2026-08-05); próximo item: Badge
