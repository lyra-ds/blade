...
> Para: sessão conduzindo o monorepo `lyra` (`packages/alpine`).
...
`WORK.md` do Blade (tasks 22 e 16, 2026-08-09).
...
que vai para `lyraTimePicker(...)` (`resources/views/components/time-picker.blade.php`,
...
lendo a **mesma** chave — `src/ThemeScript.php`, linha 15:
